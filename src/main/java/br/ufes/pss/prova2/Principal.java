...
public class Principal {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        imagens.add(new ImagemProxy(PresenterUltimasImagens.getInstance().getViewUltimasImagens(), "1_DOCKER.png", "https://blog.geekhunter.com.br/wp-content/uploads/2019/06/docker-na-pratica-como-construir-uma-aplicacao-2-1280x720.png"));
